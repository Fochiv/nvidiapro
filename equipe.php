...
<head>
    ...
    <style>
        :root {
            ...
            --accent-green: #0038A8;  /* Le bleu emblématique de Allianz */
            --green-light: #0038A8;
            --green-dark: #5a8c00;
        ...
        * {
        ...
        .background {
            ...
            background: 
                ...
                radial-gradient(circle at 90% 80%, rgba(0, 56, 168, 0.08) 0%, transparent 20%),
        ...
        .geometric-pattern {
            ...
            background-image: 
                linear-gradient(100deg, rgba(0, 56, 168, 0.05) 1px, transparent 1px),
                linear-gradient(20deg, rgba(0, 56, 168, 0.05) 1px, transparent 1px),
                linear-gradient(90deg, rgba(0, 56, 168, 0.05) 1px, transparent 1px);
        ...
        .stat-card {
            ...
            border: 1px solid rgba(0, 56, 168, 0.1); /* Bordure subtile en vert */
            text-align: center;
        ...
        .level-item {
            ...
            gap: 15px;
            padding: 15px;
            background: rgba(0, 56, 168, 0.05); /* Fond très léger en vert */
            border-radius: 12px;
            margin-bottom: 10px;
            transition: var(--transition);
        }
