        ...
        * {
        ...
        .geometric-pattern {
            ...
            background-image: 
                ...
                linear-gradient(30deg, rgba(0, 56, 168, 0.04) 12%, transparent 12.5%, transparent 87%, rgba(0, 56, 168, 0.04) 87.5%, rgba(0, 56, 168, 0.04) 0),
                linear-gradient(150deg, rgba(0, 56, 168, 0.04) 12%, transparent 12.5%, transparent 87%, rgba(0, 56, 168, 0.04) 87.5%, rgba(0, 56, 168, 0.04) 0),
...
<body>
    ...
    <div class="container">
        ...
        <div class="usage-section" id="usageSection">
            ...
            <div style="margin-top: 25px; padding: 20px; background: rgba(0, 56, 168, 0.05); border-radius: 12px;">
                <div class="eligibility-title">
